...
class TestSort{
	...
	public static int[] sortOddEven(int[]arr){
		...
		System.out.println();
		System.out.println("ood ="+odd+ " even ="+even);
		for (int i : arr1) {
			System.out.print(i+" ");
		}
		System.out.println();
		indexSelection(arr1, 0, odd-1,true);
		indexSelection(arr1, arr1.length-even-1, arr1.length-1,true);
		return arr1;
	}
